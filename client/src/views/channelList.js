  ...
  <Container fluid className='fluidD'>
             ...
             <div className='padtopC'>
              <Container>
                <Row>
                  <Col xs={6} md={3}>
                    <a className='unsub'>Remove</a>
                  <div className='channelSli' style={{backgroundImage: "url(/img/bbc.jpg)"}}>
                  ...
                  <Col xs={6} md={3}>
                    <a className='unsub'>Remove</a>
                  <div className='channelSli' style={{backgroundImage: "url(/img/cnn.png)"}}>
                  ...
                  <div className='channelAdd'>
                    <div className='text-center'>
                        <Icon.Plus size={70} color="#4e4e4e"/> 
                    </div>
                  </div>
                  </Col>
                </Row>
