...
const Dashboard = () => {
  ...
  const openNavo = async () => {
    try {
       
        console.log("here");
        const data = await openNav({});
...
const closeNavo = async () => {
  try {
     
      console.log("close");
      const data = await closeNav({});
...
<div id="mySidenav" className="sidenav">
  ...
  <div className='paddto'>
    ...
    <Container className='fluidC'>
      <section className='dassecNew'>
      ...
      <section className='lastSec'>
        <p className='latestH'>The Rain Collection</p>
        ...
        {/* <Row>
            ...
            <Col xs={6} md={3}>
                ...
                <div className='newsCat'>
                  <div className='nameC'>
                    <div className='text-center'>
                        <p className='newsCatT'>Business</p>
                      </div>
                  </div>
            ...
            <Col xs={6} md={3}>
                ...
                <div className='newsCat'>
                  <div className='nameC'>
                    <div className='text-center'>
                        <p className='newsCatT'>Politics</p>
                      </div>
                  </div>
            ...
            <Col xs={6} md={3}>
                ...
                <div className='newsCat'>
                  <div className='nameC'>
                    <div className='text-center'>
                        <p className='newsCatT'>Entertainment</p>
                      </div>
                  </div>
